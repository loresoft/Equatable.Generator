...
public static class EquatableWriter
{
    ...
    private static void GenerateEquatableFunctions(IndentedStringBuilder codeBuilder, EquatableClass entityClass)
    {
        ...
        {
            codeBuilder
                .AppendLine("static bool DictionaryEquals<TKey, TValue>(global::System.Collections.Generic.IEnumerable<global::System.Collections.Generic.KeyValuePair<TKey, TValue>>? left, global::System.Collections.Generic.IEnumerable<global::System.Collections.Generic.KeyValuePair<TKey, TValue>>? right)")
                .AppendLine("{")
                .IncrementIndent()
                ...
                .AppendLine()
                .AppendLine("if (left is global::System.Collections.Generic.IReadOnlyCollection<global::System.Collections.Generic.KeyValuePair<TKey, TValue>> leftCollection &&")
                .AppendLine("    right is global::System.Collections.Generic.IReadOnlyCollection<global::System.Collections.Generic.KeyValuePair<TKey, TValue>> rightCollection &&")
                .AppendLine("    leftCollection.Count != rightCollection.Count)")
                .AppendLine("    return false;")
                .AppendLine()
                .AppendLine("if (right is global::System.Collections.Generic.IReadOnlyDictionary<TKey, TValue> rightReadOnly)")
                .AppendLine("{")
                .IncrementIndent()
                ...
                .AppendLine("}")
                .AppendLine()
                .AppendLine("if (right is global::System.Collections.Generic.IDictionary<TKey, TValue> rightDictionary)")
                .AppendLine("{")
                .IncrementIndent()
                .AppendLine("foreach (var pair in left)")
                .AppendLine("{")
        ...
        if (entityClass.Properties.Any(p => p.ComparerType == ComparerTypes.OrderedDictionary))
        {
            codeBuilder
                ...
                .AppendLine("    return false;")
                .AppendLine()
                .AppendLine("return global::System.Linq.Enumerable.SequenceEqual(left, right,")
                .AppendLine("    global::System.Collections.Generic.EqualityComparer<global::System.Collections.Generic.KeyValuePair<TKey, TValue>>.Default);")
                .DecrementIndent()
                .AppendLine("}")
                .AppendLine();
    ...
    private static void GenerateHashCodeFunctions(IndentedStringBuilder codeBuilder, EquatableClass entityClass)
    {
        ...
        {
            codeBuilder
                .AppendLine("static int DictionaryHashCode<TKey, TValue>(global::System.Collections.Generic.IEnumerable<global::System.Collections.Generic.KeyValuePair<TKey, TValue>>? items)")
                .AppendLine("{")
                .IncrementIndent()
                .AppendLine("if (items is null)")
                .AppendLine("    return 0;")
                .AppendLine()
                .AppendLine("int hashCode = 0;")
                .AppendLine()
                .AppendLine("// sum of per-pair hashes is order-independent without sorting allocations")
                .AppendLine("foreach (var item in items)")
                .AppendLine("    hashCode += global::System.HashCode.Combine(")
                .AppendLine("        global::System.Collections.Generic.EqualityComparer<TKey>.Default.GetHashCode(item.Key!),")
        ...
        if (entityClass.Properties.Any(p => p.ComparerType == ComparerTypes.HashSet))
        {
            codeBuilder
                ...
                .AppendLine("int hashCode = 0;")
                .AppendLine()
                .AppendLine("// sum of individual hashes is order-independent without sorting allocations")
                .AppendLine("foreach (var item in items)")
                .AppendLine("    hashCode += global::System.Collections.Generic.EqualityComparer<T>.Default.GetHashCode(item!);")
                .AppendLine()
                .AppendLine("return hashCode;")
                .DecrementIndent()
                .AppendLine("}")
