...
/// </summary>
/// <remarks>
/// When <paramref name="ordered"/> is <c>false</c> (default), equality and hash code are
...
///
/// When <paramref name="ordered"/> is <c>true</c>, insertion order is part of the semantic:
...
public class DictionaryEqualityAttribute(bool ordered = false) : Attribute
{
