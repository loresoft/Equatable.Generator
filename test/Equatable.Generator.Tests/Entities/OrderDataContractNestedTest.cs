...
/// <summary>
/// Verifies that [DataContractEquatable] infers structurally-recursive comparers
...
/// </summary>
public class OrderDataContractNestedTest
{
    ...
    public void DictOfList_GeneratedEquals_ComparesInnerListsStructurally()
    {
        ...
        var a = new OrderDataContractNested { Id = 1, TagGroups = new() { ["sports"] = [10, 20], ["news"] = [30] } };
        var b = new OrderDataContractNested { Id = 1, TagGroups = new() { ["sports"] = [10, 20], ["news"] = [30] } };
    ...
    public void DictOfList_GeneratedEquals_OuterDictInsertionOrderIsIgnored()
    {
        ...
        var a = new OrderDataContractNested { Id = 1, TagGroups = new() { ["sports"] = [10], ["news"] = [20] } };
        var b = new OrderDataContractNested { Id = 1, TagGroups = new() { ["news"] = [20], ["sports"] = [10] } };
    ...
    public void DictOfList_GeneratedEquals_InnerListOrderIsEnforced()
    {
        ...
        var a = new OrderDataContractNested { Id = 1, TagGroups = new() { ["sports"] = [10, 20] } };
        var b = new OrderDataContractNested { Id = 1, TagGroups = new() { ["sports"] = [20, 10] } };
    ...
    {
        var a = new OrderDataContractNested { Id = 1, TagGroups = new() { ["sports"] = [10] } };
        var b = new OrderDataContractNested { Id = 1, TagGroups = new() { ["sports"] = [99] } };
    ...
    public void DictOfDict_GeneratedEquals_ComparesInnerDictsStructurally()
    {
        ...
        var a = new OrderDataContractNested { Id = 1, NestedMap = new() { ["outer"] = new() { ["inner"] = 42 } } };
        var b = new OrderDataContractNested { Id = 1, NestedMap = new() { ["outer"] = new() { ["inner"] = 42 } } };
    ...
    {
        var a = new OrderDataContractNested { Id = 1, NestedMap = new() { ["outer"] = new() { ["a"] = 1, ["b"] = 2 } } };
        var b = new OrderDataContractNested { Id = 1, NestedMap = new() { ["outer"] = new() { ["b"] = 2, ["a"] = 1 } } };
    ...
    {
        var a = new OrderDataContractNested { Id = 1, NestedMap = new() { ["outer"] = new() { ["k"] = 42 } } };
        var b = new OrderDataContractNested { Id = 1, NestedMap = new() { ["outer"] = new() { ["k"] = 99 } } };
    ...
    {
        // Separate inner Dictionary instances with the same content must be equal.
        var a = new OrderDataContractNested { Id = 1, Records = [new() { ["x"] = 1 }, new() { ["y"] = 2 }] };
        var b = new OrderDataContractNested { Id = 1, Records = [new() { ["x"] = 1 }, new() { ["y"] = 2 }] };
    ...
    public void ListOfDict_GeneratedEquals_OuterListOrderIsEnforced()
    {
        ...
        var a = new OrderDataContractNested { Id = 1, Records = [new() { ["x"] = 1 }, new() { ["y"] = 2 }] };
        var b = new OrderDataContractNested { Id = 1, Records = [new() { ["y"] = 2 }, new() { ["x"] = 1 }] };
    ...
    {
        var a = new OrderDataContractNested { Id = 1, Records = [new() { ["a"] = 1, ["b"] = 2 }] };
        var b = new OrderDataContractNested { Id = 1, Records = [new() { ["b"] = 2, ["a"] = 1 }] };
    ...
    {
        var a = new OrderDataContractNested
        {
            Id = 1,
            ReadOnlyTagGroups = new Dictionary<string, List<string>> { ["a"] = ["x", "y"], ["b"] = ["z"] }
        };
        var b = new OrderDataContractNested
        {
            Id = 1,
    ...
    public void GeneratedEquals_NullCollection_IsNotEqualToEmpty()
    {
        ...
        var a = new OrderDataContractNested { Id = 1, TagGroups = null };
        var b = new OrderDataContractNested { Id = 1, TagGroups = [] };
